window.addEventListener('DOMContentLoaded', async () => {
    ...
    const handleEditPerson = async id => {
        try {
            ...
            document.querySelector('#editPersonOccupation').value = person.occupation;
            document.querySelector('#editPersonMaritalStatus').value = person.maritalStatus;
        } catch ({ message }) {
            alert(message);
        }
    }
    ...
    const tableRow = ({ id, firstName, lastName, phone, occupation, maritalStatus }) => `
        <tr>
            <th scope="row">${id}</th>
            <td>${firstName}</td>
            <td>${lastName}</td>
